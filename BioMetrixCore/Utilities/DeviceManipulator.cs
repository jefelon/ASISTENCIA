    ...
    internal class DeviceManipulator
    {
        ...
        public ICollection<MachineInfo> GetLogData(ZkemClient objZkeeper, int machineNumber)
        {
...

            {
                ...
                objInfo.NumeroEquipo = machineNumber;
                objInfo.CodigoEmpleado = int.Parse(dwEnrollNumber1);
                objInfo.ModoAcceso = dwVerifyMode;
                objInfo.TipoRegistro = dwInOutMode;
                objInfo.Fecha = inputDate;
        ...
        public bool UploadFTPTemplate(ZkemClient objZkeeper, int machineNumber, List<UserInfo> lstUserInfo)
        {
            ...
            if (objZkeeper.BeginBatchUpdate(machineNumber, iUpdateFlag))
            {
                ...
                {
                    sdwEnrollNumber = lstUserInfo[i].Codigo;
                    ...
                    sPassword = lstUserInfo[i].Contrasena;
                    sEnabled = lstUserInfo[i].Activo.ToString();
