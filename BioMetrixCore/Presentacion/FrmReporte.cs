...
namespace BioMetrixCore.Presentacion
{
    public partial class FrmReporte : Form
    {
        ...
        private void btnReporte_Click(object sender, EventArgs e)
        {
            ...
            if (cmbTipo.Text=="TRABAJADOR")
            {
                ...
                if (checkBoxTodos.Checked==true)
                {
                    foreach (DataRowView item in cmbEmpleado.Items)
                    {
                        ...
                        double horacu = 0;
                        double horadom = 0;
                        int codEmpleado = Convert.ToInt32(item.Row[0].ToString());
                        ...
                        if (dt2.Rows.Count > 0)
                        {
                            var codigoEmpleado = dt2.Rows[0]["CodigoEmpleado"].ToString();
                            ...
                            oSheet.Cells[fila, 1] = codigoEmpleado;//ID EMPLEADO
                            ...
                            // TOTAL SALARIO
                            oSheet.Cells[fila, 17].Formula = string.Format("=+M" + fila + "+N" + fila + "+O" + fila + "-P"+fila);
                ...
                else
                {
                        ...
                        double horacu = 0;
                        double horadom = 0;
                        int codEmpleado = Convert.ToInt32(lblCod.Text);
                ...
                ExApp.Visible = false;
                    ...
                    OpenMicrosoftExcel(@"planilla-trabajador(copy).xlsx");
            ...
            else if (cmbTipo.Text == "EMPLEADO")
            {
                if (checkBoxTodos.Checked == true)
                {
                    ...
                    MessageBox.Show("ok");
                    OpenMicrosoftExcel(@"planilla-empleado(copy).xlsx");
                }
                else
                {
                    int col = 3, fila = 7;
        ...
        {
            lblCod.Text = cmbEmpleado.SelectedValue.ToString();
        }
